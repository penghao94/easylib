...
set(IMGUI_DIR "${ELIB_EXTERNAL_DIR}/imgui")

  if(NOT TARGET imgui)
    message(STATUS "Downloading Imgui to ${GLAD_DIR}" )
    download_imgui()
    file(GLOB IMGUI_SOURCE "${IMGUI_DIR}/*.cpp" "${IMGUI_DIR}/examples/imgui_impl_glfw.cpp" "${IMGUI_DIR}/examples/imgui_impl_opengl3.cpp")
    add_library(imgui "${IMGUI_SOURCE}")
    set(INGUI_INCLUDE_DIR "")
    list(APPEND IMGUI_INCLUDE_DIR ${IMGUI_DIR})
    list(APPEND IMGUI_INCLUDE_DIR ${IMGUI_DIR}/examples)
  ...
  target_link_libraries(elib_imgui ${ELIB_SCOPE} imgui )