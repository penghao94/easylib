...
set(GLFW_ROOT_DIR "${EXTERNAL_DIR}/glfw")
  ...
  compile_module("glfw")
  target_link_libraries(elib_glfw ${ELIB_SCOPE_WITH_GLFW} elib_opengl elib_glad  glfw )
  set(GLFW_INCLUDE_DIR "${GLFW_ROOT_DIR}/include")
  target_include_directories(elib_glfw ${ELIB_SCOPE_WITH_GLFW} ${GLFW_INCLUDE_DIR})